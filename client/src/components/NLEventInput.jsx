  ...
  return (
    <form onSubmit={handleParse} className="flex flex-col gap-2">
      <textarea
        ...
        rows={3}
        maxLength={500}
        className="w-full rounded-xl border border-stone-200 bg-[#FAF7F0] px-4 py-3 text-sm text-stone-900 placeholder:text-stone-400 resize-none focus:outline-none focus:ring-2 focus:ring-[#B45309]/30 focus:border-[#B45309] transition-colors disabled:opacity-50"
      />
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-[#B45309] hover:bg-[#92400E] text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors active:scale-[0.97] duration-150 disabled:opacity-40"
        >
